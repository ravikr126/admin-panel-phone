      ...
      <div className=" relative flex ">
        ...
        <div className="w-full items-start h-screen flex">
          ...
          <div className="w-1/2 h-full flex flex-col p-20 text-center">
            ...
            <h3 className="text-green-950 text-3xl p-5">
              Sign In to Logo. to continue
            </h3>
            ...
            <p>
              <a href="#">
                {" "}
                <span className="text-red-500">Forget your password </span>
              </a>
            </p>
            <button className="bg-blue-500 rounded-lg m-5 text-3xl p-5">
              {" "}
              Sign Up
            </button>
          </div>
