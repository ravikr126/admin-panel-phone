    ...
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
                ...
                <input id="username" type="text" placeholder='Name' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
            </div>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Mobile Number</label>
                <input id="number" type="number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
            </div>
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Gender</label>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">State</label>
                <select class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    <option>Delhi</option>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">City</label>
                <select class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    <option>Delhi</option>
                    <option>Noida</option>
                    <option>Other</option>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Country</label>
                <select class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    <option>India</option>
                    <option>USA</option>
                    <option>Other</option>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Address</label>
        ...
        <div class="flex justify-end mt-6">
            <button class="px-6 py-2 leading-5 text-black transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-700 font-bold focus:outline-none focus:bg-gray-600">Save</button>
        </div>
    </form>
</section>
