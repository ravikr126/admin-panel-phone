  ...
  return (
    <div className="m-10">
      <div class="max-w-7xl mt-10 p-8 mx-auto bg-white rounded-md shadow-md border border- flex flex-row justify-between">
        <h1 className="font-serif	text-3xl font-bold	">Order List </h1>
      ...
      <div class="max-w-7xl shadow-sm mt-20 m-auto bg-white rounded-md border border-">
        <table class="min-w-full bg-white rounded whitespace-nowrap">
          ...
          <tbody class="text-sm bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-3 py-4 text-gray-600 ">#102</td>
              ...
              <td class="px-3 py-4 text-right text-gray-500 ">5 Items</td>
