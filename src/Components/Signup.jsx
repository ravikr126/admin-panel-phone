  ...
  return (
   ...
   <div className=' relative flex '>
    ...
    <div className='w-1/2 h-full flex flex-col p-20 text-center'>
        ...
        <h1 className='text-blue-950 font-bold text-3xl p-5'> Create an Account</h1>
        <h2 className='text-green-950 text-3xl p-5'>Create a new Account Login</h2>
        <div className='flex flex-col text-center justify-center'>
            <input type="text text-xl" placeholder='Name'  className='border p-3 m-3 rounded-lg border-black' />
            ...
            <input type="password" placeholder='Confirm Password'  className='border p-3 m-3 rounded-lg border-black'/>

        </div>
        <p>Already  have an account? <span className='text-red-500'> Sign in </span>
        </p>
        <button className='bg-blue-500 rounded-lg m-5 text-3xl '> Sign Up</button>
